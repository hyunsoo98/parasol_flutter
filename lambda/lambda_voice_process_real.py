...
try:
    ...
    # MultiBranchNet 클래스 정의 (의존성이 있을 때만)
...
def analyze_voice_real(audio_path: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if not HAS_DEPENDENCIES:
        print("PyTorch/librosa dependencies not available, returning basic analysis")
        return {
            ...
            "ensemble_result": {
                "predicted_class": "HC",
                "ensemble_probability": 0.3,
                "confidence": "medium"
            },
            "individual_predictions": [
                {"model": "cnn", "probability": 0.3, "prediction": "HC"},
                {"model": "rnn", "probability": 0.3, "prediction": "HC"},
                {"model": "mlp", "probability": 0.3, "prediction": "HC"}
            ],
            "message": "Basic analysis completed - PyTorch/librosa not available"
        }
